...
const build_text = [
	...
	"*grunt* [On the right, we have the empty proto-cell. On the left we have the cell building tools. Grow or shrink the cell with cytoplasm, then place organelles in the cell from the bank]",
	...
	"*grunt* [You will probably want to keep as many organelles as possible, but if you ever need to get rid of an organelle from the bank, just use the hazardous waste bin in the corner.]",
